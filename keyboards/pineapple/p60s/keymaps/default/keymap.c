...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* Base
   ...
   * |------+------+------+------+------+------|   |------+------+------+------+------+------+      +------+------+------.
   * | LCTRL|FNC/ｱ | LGUI | Alt  | Space|    |Space| NUM  | Alt  | RCTRL|      | Caps |  Del |      | Left | Down | Right|
   * `----------------------------------'    `---------------------------      ---------------      ---------------------.
   */
    [_BASE] = LAYOUT(
      ...
      KC_LCTL,  LT(_FNC,A(KC_GRV)), KC_LGUI, KC_LALT, KC_SPC, KC_SPC, LT(_NUM,JP_MHEN), KC_RALT, KC_RCTL, KC_CAPS,  KC_DEL,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
 /* Fnc
   * ,-----------------------------------------.   ,------------------------------------------------.
