...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* Base
   ...
   * |------+------+------+------+------+------|   |------|------+------+------+------+------+-------------.       ------.
   * | Caps |  a/A |  s/S |  d/D |  f/F |  g/G |   |  h/H |  j/J |  k/K |  l/L |  ;/: |  '/" |Enter |               PgDn |
   * |------+------+------+------+------+------|   |------+------+------+------+------+------+------+-------------
   * |LShift|  z/Z |  x/X |  c/C |  v/V |  b/B |   |  n/N |  m/M |  ,/< |  ./> |  //? |RShift|      | PgUp |  Up  |
   * |------+------+------+------+------+------|   |------+------+------+------+------+------+      +------+------+------.
   * | LCTRL|FNC/ｱ | LGUI | Alt  | Space|    |Space| NUM  | Alt  | RCTRL|      |   `  |  Del |      | Left | Down | Right|
   * `----------------------------------'    `---------------------------      ---------------      ---------------------.
   */
    [_BASE] = LAYOUT(
      ...
      KC_LCTL,  LT(_FNC,A(KC_GRV)), KC_LGUI, KC_LALT, KC_SPC, KC_SPC, LT(_NUM,JP_MHEN), KC_RALT, KC_RCTL, KC_GRV,  KC_DEL,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
 /* Fnc
   * ,-----------------------------------------.   ,------------------------------------------------.
