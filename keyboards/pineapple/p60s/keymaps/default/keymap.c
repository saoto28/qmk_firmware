...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* Base
   ...
   * |------+------+------+------+------+------|   |------|------+------+------+------+------+-------------.       ------.
   * |LShift|  a/A |  s/S |  d/D |  f/F |  g/G |   |  h/H |  j/J |  k/K |  l/L |  ;/: |  '/" |Enter |               PgDn |
   * |------+------+------+------+------+------|   |------+------+------+------+------+------+------+-------------
   * | LCTRL|  z/Z |  x/X |  c/C |  v/V |  b/B |   |  n/N |  m/M |  ,/< |  ./> |  //? |RShift|      | PgUp |  Up  |
   * |------+------+------+------+------+------|   |------+------+------+------+------+------+      +------+------+------.
   * | Caps | LGUI | Alt  | NUM  | Space|    |Space|  FNC | Alt  | RCTRL|      | INS  |  Del |      | Left | Down | Right|
   * `----------------------------------'    `---------------------------      ---------------      ---------------------.
   */
    [_BASE] = LAYOUT(
      ...
      KC_LCTL,  KC_Z,    KC_X,      KC_C,     KC_V,            KC_B,     KC_N,   KC_M,           KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, KC_PGUP, KC_UP,
      KC_CAPS,  KC_LGUI, KC_LALT, LT(_NUM,JP_MHEN), KC_SPC, KC_SPC, LT(_FNC,JP_HENK), KC_RALT,   KC_RCTL, KC_INS,  KC_DEL,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
 /* Fnc
   * ,-----------------------------------------.   ,------------------------------------------------.
