...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_GRV,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_UP,   KC_RSFT,
        KC_LCTL, TT(_FNC),KC_LGUI, KC_LALT, TT(_NUM),         KC_SPC,    KC_SPC,  TT(_FNC),KC_RALT, KC_RCTL, KC_LEFT,          KC_DOWN, KC_RGHT
    ),
    [_FNC] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PDOT,
        A(KC_GRV),KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,              KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
        A(KC_GRV),_______,KC_PSCR, _______, _______, KC_HOME, _______,   KC_PGUP, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          _______,
